...
public class MakeTestData implements ApplicationRunner {
    ...
    public  void makePlainUsers(){
       ...
       Member m2 =memberRepository.save(new Member("HW","hw@a.dk","test12","Hanne","Wonnegut","Lyngbyvje 34","Lyngby","2800"));
        ...
        Reservation res = reservationRepository.findReservationsByReservedCar_IdAndRentalDate(carVolvo.getId(),LocalDate.of(2022,3,1));
        if(res == null) {
            Reservation res2 = new Reservation(LocalDate.of(2022, 3, 1), carVolvo, m1);
            reservationRepository.save(res2);
        }else {
            System.out.println("Car is already reserved this day");
        }
